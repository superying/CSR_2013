...
[x, y, t] = size(M); %M is the matrix composed of the resized video returned by load_clip2dm.m
    ...
    for y_offset = 0:ds_st_per_cf_y-1 %stride indices per complex fovea
        for t_offset = 0:ds_st_per_cf_t-1
            ...
            if params.feature.num_layers == 1
                act_l1 = activateISA(N, network.isa{1}, params.postact.layer1);           %N is M after being cropped and reshaped                     
