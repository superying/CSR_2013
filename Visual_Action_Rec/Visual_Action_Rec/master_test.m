function master_test(dim3D)
path = './'; %current folder

% ***CHANGE TO DESIRED PATHS***
if dim3D
    params.afspath = '/home/hornew/beta/';
else
    params.afspath = '/home/hornew/DataSet/Hollywood2/';
end
params.savepath = '/home/hornew/Test/'; %path to save intermediate (before svm classification) results
...
%% set params
if dim3D
    params.infopath = '/home/hornew/clipsets/';
    params.avipath{1} = params.afspath;
else
    %path to videos
...
test_features_s2isa(network, params, dim3D)
end